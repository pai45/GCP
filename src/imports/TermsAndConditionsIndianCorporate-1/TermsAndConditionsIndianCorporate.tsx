import svgPaths from "./svg-19gco59w4q";
import imgCompanyLogo from "./4c465e26255bb39f691f687da9cf124341445b5d.png";
...
function Frame39() {
  return (
    <div className="content-stretch flex h-[64px] items-center relative shrink-0 w-full">
      <Frame40 />
      <Frame41 />
    </div>
  );
...
function Frame81() {
  return (
    <div className="content-stretch flex h-[200px] items-start relative shrink-0 w-full">
      <Frame82 />
      <Frame83 />
    </div>
  );
...
function Frame32() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start relative shrink-0 w-[850px]">
      <Frame31 />
      <Frame13 />
    </div>
  );
