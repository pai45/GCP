import svgPaths from "./svg-emcdcu18fe";
...
function Frame4() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full">
      <p className="font-['Lato:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#181d27] text-[16px] tracking-[-0.16px] whitespace-nowrap">Page: 3/4</p>
    </div>
  );
}
